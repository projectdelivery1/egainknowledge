...
export default function DeviceBreakdownChart() {
  ...
  // Get device breakdown data and ensure it's in the right format
  const rawData = mockAnalyticsData.deviceBreakdown
  ...
  const COLORS = theme === "dark" ? ["#60a5fa", "#c084fc", "#4ade80"] : ["#3b82f6", "#8b5cf6", "#22c55e"]
